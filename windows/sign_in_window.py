...
class SignIn(QMainWindow):
    ...
    def signIn(self):
        ...
        # TODO refactor sign in procedure
        try:
        ...
        if len(login) != 0 and info[1]:
            with open("user_data/face_photo.png", "wb") as photo:
                photo.write(info[2])
            mtcnn = MTCNN(image_size=500, margin=0, min_face_size=200)  # initializing mtcnn for face detection
            ...
            if count_success > 0:
                ...
                self.ui.helloTitle.setText("Error, try again or sign in with password")
