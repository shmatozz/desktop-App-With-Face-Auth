...
class UiSignUp(object):
    ...
    def __init__(self):
        ...
        # text fields
        self.upload_mes = None
        self.passwordRep = None
        self.password = None
        self.login = None
        self.email = None
        self.surname = None
        self.name = None
        self.RegistrationTitle = None
    ...
    def setupUi(self, MainWindow):
        ...
        self.upload_layout.setSizeConstraint(QtWidgets.QLayout.SizeConstraint.SetMinimumSize)
        self.upload_layout.setSpacing(0)
        self.upload_layout.setObjectName("uploadLayout")
        self.upload_mes = QtWidgets.QLabel(parent=self.frame)
        self.upload_mes.setEnabled(False)
        self.upload_mes.setMaximumSize(QtCore.QSize(16777215, 30))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(9)
        self.upload_mes.setFont(font)
        self.upload_mes.setObjectName("uploadMes")
        self.upload_layout.addWidget(self.upload_mes, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.upload_button = QtWidgets.QPushButton(parent=self.frame)
        self.upload_button.setMinimumSize(QtCore.QSize(150, 0))
        self.upload_button.setMaximumSize(QtCore.QSize(150, 30))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        ...
        self.upload_layout.addWidget(self.upload_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        ...
        self.signup_button.setMinimumSize(QtCore.QSize(200, 50))
        self.signup_button.setMaximumSize(QtCore.QSize(200, 50))
        self.signup_button.setBaseSize(QtCore.QSize(200, 40))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(16)
        font.setBold(False)
        ...
        self.signup_button.setObjectName("SingUpButton")
        self.verticalLayout_2.addWidget(self.signup_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
        self.back_button = QtWidgets.QPushButton(parent=self.frame)
        self.back_button.setMinimumSize(QtCore.QSize(80, 0))
        self.back_button.setMaximumSize(QtCore.QSize(80, 30))
        font = QtGui.QFont()
        font.setFamily("Bahnschrift")
        font.setPointSize(11)
        font.setBold(False)
        ...
        self.verticalLayout_2.addWidget(self.back_button, 0, QtCore.Qt.AlignmentFlag.AlignHCenter)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.upload_mes.setText(_translate("MainWindow",
